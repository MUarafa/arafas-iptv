...
export var LANGUAGE_KEY = "iptv:language",
  ...
  MESSAGES = {
    en: {
      ...
      "accounts.hint": "OK switches to an account. Yellow removes one. Each account keeps its own Continue Watching and favourites.",
      "accounts.active": "In use",
      "accounts.add": "Add account",
      "accounts.freeDetail": "The free public playlist",
      "accounts.switching": "Switching account…",
      "accounts.already": "This account is already in use.",
      "accounts.cantRemoveActive": "Switch to another account before removing this one.",
      "accounts.removed": "Account removed",
      "settings.account": "Account",
      "settings.accountDetail": "Sign in with your Xtream portal or an M3U playlist.",
      "nav.freetv": "Free TV",
      ...
      "welcome.inactive": "This account is not active - it may have expired.",
      "welcome.notPortal": "That address did not answer like an IPTV portal. Check the URL - or your network may be showing its own page.",
      "welcome.noAnswer": "The server did not answer. Check the address and your internet connection.",
      "welcome.serverError": "The server had a problem answering. Try again in a moment.",
      ...
      "player.titleUnavailable": "This title is not available right now. Try again in a moment.",
      "player.providerBlocked":
        "Your provider is not sending this title — its video host has blocked it. Live TV still works.",
      "player.fit": "Fit",
    ...
    ar: {
      ...
      "nav.account": "الحسابات",
      "accounts.title": "الحسابات",
      "accounts.hint": "OK للتبديل لحساب، والأصفر لحذفه. كل حساب له المشاهدة والمفضلة بتوعه.",
      "accounts.active": "مستخدم دلوقتي",
      "accounts.add": "إضافة حساب",
      "accounts.freeDetail": "القائمة المجانية العامة",
      "accounts.switching": "جاري تبديل الحساب…",
      "accounts.already": "الحساب ده مستخدم بالفعل.",
      "accounts.cantRemoveActive": "بدّل لحساب تاني الأول قبل ما تحذف ده.",
      "accounts.removed": "اتحذف الحساب",
      "settings.account": "الحساب",
      "settings.accountDetail": "سجّل دخول بحساب Xtream أو قائمة M3U.",
      ...
      "welcome.inactive": "الحساب ده مش مفعّل، ممكن يكون انتهى.",
      "welcome.notPortal": "العنوان ده مردّش زي سيرفر IPTV. راجع الرابط، أو ممكن الشبكة بتعرض صفحة بتاعتها.",
      "welcome.noAnswer": "السيرفر مردّش. راجع العنوان والإنترنت.",
      "welcome.serverError": "السيرفر فيه مشكلة دلوقتي. جرّب تاني كمان شوية.",
      ...
      "player.titleUnavailable": "العنوان ده مش متاح دلوقتي. جرّب تاني كمان شوية.",
      "player.providerBlocked":
        "المزوّد مش باعت العمل ده — استضافة الفيديو عنده محجوبة. البث المباشر شغال.",
      "player.fit": "ملائم",
